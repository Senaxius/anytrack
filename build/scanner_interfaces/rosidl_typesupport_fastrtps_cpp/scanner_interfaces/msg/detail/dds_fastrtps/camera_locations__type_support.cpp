...
#include "scanner_interfaces/msg/detail/camera_locations__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const scanner_interfaces::msg::Location &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  scanner_interfaces::msg::Location &);
...
cdr_serialize(
  const scanner_interfaces::msg::CameraLocations & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  scanner_interfaces::msg::CameraLocations & ros_message)
{
  // Member: locations
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: locations
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        scanner_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Location(
...
{
  auto typed_message =
    static_cast<const scanner_interfaces::msg::CameraLocations *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scanner_interfaces::msg::CameraLocations *>(
    untyped_ros_message);
...
{
  return &scanner_interfaces::msg::typesupport_fastrtps_cpp::_CameraLocations__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scanner_interfaces, msg, CameraLocations)() {
  return &scanner_interfaces::msg::typesupport_fastrtps_cpp::_CameraLocations__handle;
}
