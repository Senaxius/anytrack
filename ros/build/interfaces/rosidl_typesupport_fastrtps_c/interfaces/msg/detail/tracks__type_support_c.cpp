...
#include "interfaces/msg/detail/tracks__rosidl_typesupport_fastrtps_c.h"
...
#include "interfaces/msg/detail/object__functions.h"  // tracks
...
using _Tracks__ros_msg_type = interfaces__msg__Tracks;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tracks
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, msg, Object
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tracks
  {
    ...
    if (ros_message->tracks.data) {
      interfaces__msg__Object__Sequence__fini(&ros_message->tracks);
    }
    if (!interfaces__msg__Object__Sequence__init(&ros_message->tracks, size)) {
...
size_t get_serialized_size_interfaces__msg__Tracks(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Tracks__ros_msg_type * ros_message = static_cast<const _Tracks__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name tracks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_interfaces__msg__Object(
...
static uint32_t _Tracks__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Tracks(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Tracks(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: tracks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_interfaces__msg__Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Tracks__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Tracks(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Tracks)() {
