...
{
  new (message_memory) interfaces::msg::Tracks(_init);
}

void Tracks_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::Tracks *>(message_memory);
  typed_message->~Tracks();
}

size_t size_function__Tracks__tracks(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<interfaces::msg::Object> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<interfaces::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<interfaces::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const interfaces::msg::Object *>(
    get_const_function__Tracks__tracks(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces::msg::Object *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<interfaces::msg::Object *>(
    get_function__Tracks__tracks(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces::msg::Object *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Tracks_message_member_array[2] = {
  {
    ...
    offsetof(interfaces::msg::Tracks, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::msg::Object>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::Tracks, tracks),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<interfaces::msg::Tracks>()
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Tracks_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, Tracks)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Tracks_message_type_support_handle;
}
