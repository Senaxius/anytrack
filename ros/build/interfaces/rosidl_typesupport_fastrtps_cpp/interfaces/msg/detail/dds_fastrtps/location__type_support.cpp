...
#include "interfaces/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Location__handle;
}
