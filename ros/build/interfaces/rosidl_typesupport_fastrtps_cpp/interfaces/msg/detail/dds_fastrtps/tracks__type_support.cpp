...
#include "interfaces/msg/detail/tracks__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Tracks & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Tracks & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: tracks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Tracks *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Tracks *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Tracks__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Tracks)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Tracks__handle;
}
