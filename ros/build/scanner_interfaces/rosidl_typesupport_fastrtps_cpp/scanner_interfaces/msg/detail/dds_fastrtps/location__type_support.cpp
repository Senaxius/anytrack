...
#include "scanner_interfaces/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const scanner_interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scanner_interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  return &scanner_interfaces::msg::typesupport_fastrtps_cpp::_Location__handle;
}
