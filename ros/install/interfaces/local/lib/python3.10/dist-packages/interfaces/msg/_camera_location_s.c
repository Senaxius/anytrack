...
bool interfaces__msg__camera_location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._camera_location.CameraLocation", full_classname_dest, 46) == 0);
  }
  interfaces__msg__CameraLocation * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of CameraLocation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._camera_location");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraLocation");
